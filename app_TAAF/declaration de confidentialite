**Politique de confidentialité de Terres Australes Action Fun**
...
Pour plus d'informations sur la manière dont Google Firebase gère les données personnelles, veuillez consulter leur politique de confidentialité disponible à l'adresse suivante : [Politique de confidentialité de Google Firebase](lien_vers_la_politique_de_confidentialite_de_Firebase)
...
For more information on how Google Firebase handles personal data, please refer to their privacy policy available at the following link: [Google Firebase Privacy Policy](link_to_Firebase_privacy_policy)
